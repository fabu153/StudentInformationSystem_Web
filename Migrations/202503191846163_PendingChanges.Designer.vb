...
Namespace Migrations
    ...
    Public NotInheritable Partial Class PendingChanges
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(PendingChanges))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202503191846163_PendingChanges"
            End Get
        End Property
